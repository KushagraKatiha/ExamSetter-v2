const courses = [
  ...
  },
  {
    ...
    fullName:
      "B.Tech. (CSE) Specialization in Artificial Intelligence, Machine Learning & Deep Learning",
  },
  {
    value: "B.Tech CTIS",
    fullName:
      "B.Tech.(CSE)-Cloud Technology & Information Security (CTIS) (In Collaboration with i-Nurture) (Was Offered till 2023-24.)",
  },
  {
    value: "B.Tech i-Nurture",
    fullName:
      "B.Tech.(CSE)-Cyber Security (In Collaboration with i-Nurture) (Was Offered till 2023-24.)",
  },
  {
    value: "B.Tech AI",
    fullName:
      "B.Tech.(CSE)-specialisation in Artificial Intelligence (In Collaboration with i-Nurture) (Was Offered till 2023-24.)",
  },
  {
    value: "B.Tech IBM",
    fullName:
      "B.Tech.(CSE)-Application Development using Cloud & Analytics Platform (In Collaboration with IBM)",
  },
  {
    value: "B.Tech TCS",
  ...
  },
  {
    value: "BCA MAWT",
    fullName:
      "BCA-Mobile Applications & Web Technologies (MAWT) (In collaboration with i-Nurture) (Was Offered till 2023-24.)",
  },
  {
    value: "BCA CTIS",
    fullName:
      "BCA-Cloud Technology & Information Security (CTIS) (In collaboration with i-Nurture) (Was Offered till 2023-24.)",
  },
  {
    value: "BCA Hons.",
